...
namespace NSE.WebApp.MVC.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        public async Task<IActionResult> AdicionarItemCarrinho(ItemProdutoViewModel itemProduto)
        {
            ...
            //Diferença do redirect e do return view:
            //Quando é redirect, vai obter os itens do carrinho atualizados,
            //Quando retorna só a view, retorna a View já com os erros a serem exibidos na tela
        ...
        private void ValidarItemCarrinho(ProdutoViewModel produto, int quantidade)
        {
            ...
            if (quantidade > produto.QuantidadeEstoque) AdicionarErroValidacao($"O produto {produto.Nome} possui {produto.QuantidadeEstoque} em estoque, você selecionou {quantidade}");
        }
    }
}
